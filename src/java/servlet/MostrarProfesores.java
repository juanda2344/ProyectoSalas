 ...
 * @author Usuario
 */
@WebServlet(name = "MostrarProfesores", urlPatterns = {"/mostrarp"})
public class MostrarProfesores extends HttpServlet {
    ...
    {
        request.setAttribute("MostrarProfesores", CRUDProfesores.getAll());
