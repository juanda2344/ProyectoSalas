...
<html>
    ...
    <body>
        <h1>Editar Externo</h1>
        <div style="width: 900px; margin-left: auto; margin-right: auto">
            <c:forEach items="${externo}" var="p">
                    ...
                    Entidad:<br>
                    <input type="text" value="${p.entidad}" id="entidad" style="width: 200px"><br>
                 
                    <button type="submit" id="modificarExterno">Ingresar</button>
            </c:forEach>
